...
class FPN(nn.Module):
    ...
    def forward(self, x, g):
        ...
        s5_0 = s5_0 * self._down_scales(g,4)
        ...
        s4_0 = s4_0 * self._down_scales(g, 2)
        ...
        s2_0 = s2_0 * self._upsample(g, h, w)
        s2 = F.relu(self.gn1(self.semantic_branch(s2_0)))

        return self._down_scales(self.conv3(s2 + s3 + s4 + s5),2) 
